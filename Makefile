...
DATA_DIRS:=$(foreach package,$(OLD_PKG_DB_FILES),$(call existing,$(call part,data-dir,$(package))))
HADDOCK_INTERFACES:=$(foreach package,$(OLD_PKG_DB_FILES),$(call existing,$(call part,haddock-interfaces,$(package))))
...
TARGET_DATA_DIRS:=$(call uniq,$(TARGET_SHARE_DIRS))
